            ...
            if debug:
                ...
                for rec_img, rec_text in rec_results:
                    ...
                    if '>' in rec_text:
                        ...
                        if len(words[-1]) > 5 and [words[-1]] not in license_plate_values:
                            #print(license_plate_values)
                            license_plate_values.append([words[-1]])
...
#print(license_plate_values)
file = open('license_plates.csv', 'w+', newline ='')
 
# writing the data into the file
with file:   
    write = csv.writer(file)

    write.writerows(license_plate_values)
